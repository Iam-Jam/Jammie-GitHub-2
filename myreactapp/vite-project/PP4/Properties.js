          ...
          <div className="col-lg-5">
            <div className="card-body">
              <div className="container properties-scn-2">
                ...
                <p className="text-left" style={{ fontSize: '28px' }}>I&aposm sure we have what it is you are looking for. If not, we&aposd be more than happy to search for properties that suit your needs.</p>
              </div>
            </div>
          </div>
